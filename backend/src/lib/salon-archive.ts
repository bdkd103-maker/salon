...
type BuildSalonArchiveInput = {
  ...
  offers?: Array<{ id: string; salonId: string; title: string; description: string | null; price: string | Prisma.Decimal | null; isActive: boolean; availableSlots: number; discount: string | Prisma.Decimal | null; endAt: Date | string | null; endTime: string | null; serviceName: string | null; startAt: Date | string; startTime: string }>;
  ...
  liveStatus?: Array<{ salonId: string; operationalState: string; observedAt: Date | string; expiresAt: Date | string | null; source: string }>;
